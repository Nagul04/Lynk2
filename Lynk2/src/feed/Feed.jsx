...
import test6 from '/src/test6.json';
import test7 from '/src/test7.json';
import test8 from '/src/test8.json';
import test9 from '/src/test9.json'; 
import test10 from '/src/test10.json';  
import test12 from '/src/test11.json';  
import './Feed.css';
